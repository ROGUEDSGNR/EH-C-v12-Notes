...
5. [Encryption Algorithms](#5-encryption-algorithms)
    5.1. [Ciphers](#51-ciphers)  
	    5.1.1. [Types of Ciphers](#511-types-of-ciphers)  
	    5.1.2. [Classical Ciphers](#512-classical-ciphers)  
	    5.1.3. [Modern Ciphers](#513-modern-ciphers)
6. [Symmetric Algorithms](#6-symmetric-algorithms)  
    6.1. [Data Encryption Standard (DES)](#61-data-encryption-standard-des)  
    6.2. [Advanced Encryption Standard (AES)](#62-advanced-encryption-standard-aes)  
    6.3. [RC4, RC5, and RC6 Algorithms](#63-rc4-rc5-and-rc6-algorithms)  
    6.4. [Blowfish](#64-blowfish)  
    6.5. [Twofish and Threefish](#65-twofish-and-threefish)  
    6.6. [Serpent and TEA](#66-serpent-and-tea)  
    6.7. [CAST-128](#67-cast-128)  
    6.8. [GOST Block Cipher and Camellia](#68-gost-block-cipher-and-camellia)
7. [Asymmetric Algorithms](#7-asymmetric-algorithms)  
    7.1. [Rivest Shamir Adleman (RSA)](#71-rivest-shamir-adleman-rsa)  
    7.2. [Diffie-Hellman](#72-diffie-hellman)  
    7.3. [YAK Protocol](#73-yak-protocol)
8. [Digital Signature Algorithms](#8-digital-signature-algorithms)  
    8.1. [Digital Signature Algorithm (DSA)](#81-digital-signature-algorithm-dsa)
9. [Message Digest Functions](#9-message-digest-functions)  
    9.1. [One-Way Hash Functions](#91-one-way-hash-functions)
